...
`PUBLISH_TO_PYPI=true` and a PyPI Trusted Publisher is configured) publishes to PyPI.
If the install check fails, nothing is released: fix it, and move the tag or bump
the version.
